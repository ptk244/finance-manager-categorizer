...
class AgentTeamService:
    ...
    async def process_complete_workflow(self, file_path: str, file_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                for transaction in categorization_result['categorized_statement'].transactions:
    ...
    async def process_file_only(self, file_path: str, file_name: str) -> Dict[str, Any]:
        """Process file and extract transactions only"""
        try:
            logger.info("Processing file extraction only")
            result = await file_processor_agent.process_uploaded_file(file_path, file_name)
            return result
        except Exception as e:
